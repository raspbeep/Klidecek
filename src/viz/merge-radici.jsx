  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
      <div style={{ padding: 8, background: "var(--bg-inset)", borderRadius: 8, display: "flex", flexWrap: "wrap", gap: 8, alignItems: "center", fontSize: 11.5 }}>
        ...
        <button className="viz-btn" data-active={mode === "bucket"} onClick={() => setMode("bucket")}>Bucket Sort (strom)</button>
        <button className="viz-btn" data-active={mode === "batcher"} onClick={() => setMode("batcher")}>Batcher OEMS</button>
        <button className="viz-btn" data-active={mode === "pipeline"} onClick={() => setMode("pipeline")}>Pipeline Merge</button>
