...
// — NMAL content (BAYa/SUR/SFC/SLA + KNN) —
register("aco-tsp", () => import("./aco-tsp.jsx"));
register("anchor-grid", () => import("./anchor-grid.jsx"));
register("bayes-coin-update", () => import("./bayes-coin-update.jsx"));
register("bayes-conjugate-beta", () => import("./bayes-conjugate-beta.jsx"));
register("bayes-net-dsep", () => import("./bayes-net-dsep.jsx"));
register("bayes-predictive", () => import("./bayes-predictive.jsx"));
register("belief-propagation", () => import("./belief-propagation.jsx"));
register("cramer-lines", () => import("./cramer-lines.jsx"));
register("determinant-area", () => import("./determinant-area.jsx"));
register("eigenvector-transform", () => import("./eigenvector-transform.jsx"));
register("feature-separability", () => import("./feature-separability.jsx"));
register("fuzzy-control", () => import("./fuzzy-control.jsx"));
register("fuzzy-kmeans", () => import("./fuzzy-kmeans.jsx"));
register("fuzzy-membership", () => import("./fuzzy-membership.jsx"));
register("gauss-elimination", () => import("./gauss-elimination.jsx"));
register("gaussian-linear-clf", () => import("./gaussian-linear-clf.jsx"));
register("genetic-algorithm", () => import("./genetic-algorithm.jsx"));
register("gibbs-sampling", () => import("./gibbs-sampling.jsx"));
register("gmm-boundary", () => import("./gmm-boundary.jsx"));
register("gmm-density", () => import("./gmm-density.jsx"));
register("gmm-em", () => import("./gmm-em.jsx"));
register("gp-crossover", () => import("./gp-crossover.jsx"));
register("hmm-forward-backward", () => import("./hmm-forward-backward.jsx"));
register("hmm-generate", () => import("./hmm-generate.jsx"));
register("hmm-viterbi", () => import("./hmm-viterbi.jsx"));
register("hopfield-recall", () => import("./hopfield-recall.jsx"));
register("iou-nms", () => import("./iou-nms.jsx"));
register("lbf-rbf-response", () => import("./lbf-rbf-response.jsx"));
register("lda-projection", () => import("./lda-projection.jsx"));
register("logistic-sigmoid", () => import("./logistic-sigmoid.jsx"));
register("matrix-multiply", () => import("./matrix-multiply.jsx"));
register("mdp-gridworld", () => import("./mdp-gridworld.jsx"));
register("perceptron-learn", () => import("./perceptron-learn.jsx"));
register("pgm-factor-graph", () => import("./pgm-factor-graph.jsx"));
register("pso-swarm", () => import("./pso-swarm.jsx"));
register("q-learning-grid", () => import("./q-learning-grid.jsx"));
register("rbf-network", () => import("./rbf-network.jsx"));
register("rough-sets", () => import("./rough-sets.jsx"));
register("siamese-arch", () => import("./siamese-arch.jsx"));
register("svm-kernel", () => import("./svm-kernel.jsx"));
register("svm-margin", () => import("./svm-margin.jsx"));
register("svm-soft-margin", () => import("./svm-soft-margin.jsx"));
register("triplet-loss", () => import("./triplet-loss.jsx"));
register("variational-bayes", () => import("./variational-bayes.jsx"));
