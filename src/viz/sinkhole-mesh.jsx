  ...
  return (
    <div style={ctn}>
      <div className="viz-controls">
        ...
        <button className="viz-btn" data-active={compromised === "E"}
          style={compromised === "E" ? { background: "#e07a5f", borderColor: "#e07a5f", color: "var(--bg-inset)" } : undefined}
        ...
        <button className="viz-btn" data-active={selective}
          style={selective ? { background: "#e07a5f", borderColor: "#e07a5f", color: "var(--bg-inset)" } : undefined}
      ...
      <div className="viz-controls">
        ...
        <select className="viz-select" value={packetType} onChange={(e) => setPacketType(e.target.value)}>
