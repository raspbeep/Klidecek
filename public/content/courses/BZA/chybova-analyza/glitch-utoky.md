...
## Praktický příklad — výstupní cyklus
...
* **PIC 16C84** (~2000) — *unsigned* Vpp glitch → smazání "lock bitu" bez smazání programu → dump firmware.
* **Apple T2 chip** ([checkm8, 2019](https://github.com/axi0mX/ipwndfu)) — fault injection v boot ROM iPhone (USB DFU mode); unfixable v hardware.
* **STM32 Trusted Execution Environment** ([Goodspeed 2018](https://www.youtube.com/watch?v=UMr-iSRJBfg)) — voltage glitch obchází ETZ (Embedded TrustZone).
