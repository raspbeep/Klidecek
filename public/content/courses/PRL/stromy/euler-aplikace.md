...
**Klíčové pozorování**: preorder($v$) = 1 + (počet *dopředných* hran v Etour *před* první dopřednou hranou vedoucí do $v$).
...
1. Každý uzel má unikátní ID (např. $2^n$ pro $n$-bit IDs).
