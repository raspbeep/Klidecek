...
::: math
\begin{aligned}
\text{SHUNT s } + : & \quad f' = (a_R + a_L X + a_R c + b_R) \mapsto \text{nový } aX + b \\
\text{SHUNT s } \times : & \quad f' = a_L X \cdot c + b_L \cdot c + ...
\end{aligned}
:::
...
Strom: $(2 + 5) \times 3 + 12 / 4$ uložený v binárním stromě.
...
**Výsledek**: $(2 + 5) \cdot 3 + 12 / 4 = 21 + 3 = 24$ (kdyby vstup byl tento).
