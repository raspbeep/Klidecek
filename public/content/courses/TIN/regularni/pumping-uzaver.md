...
<svg viewBox="0 0 540 200" font-family="ui-sans-serif, system-ui" font-size="11">
  ...
  <text x="50" y="64" text-anchor="middle">p₀</text>
  <text x="110" y="64" text-anchor="middle">p₁</text>
  <text x="75" y="20" text-anchor="middle" fill="var(--text-muted)" font-size="11">M₁ pro L₁</text>
  ...
  <text x="450" y="64" text-anchor="middle">q₀</text>
  <text x="510" y="64" text-anchor="middle">q₁</text>
