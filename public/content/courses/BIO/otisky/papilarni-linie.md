---
title: Papilární linie a anatomie otisku
---
...
<svg viewBox="0 0 540 220" font-family="ui-sans-serif, system-ui" font-size="11">
  <g fill="var(--bg-card)" stroke="var(--accent)" stroke-width="1.3">
    <rect x="40" y="40" width="460" height="160" rx="4"/>
  </g>
  <g fill="rgba(255, 220, 180, 0.6)" stroke="var(--text)" stroke-width="0.8">
    <path d="M40,80 Q70,60 100,80 Q130,100 160,80 Q190,60 220,80 Q250,100 280,80 Q310,60 340,80 Q370,100 400,80 Q430,60 460,80 Q490,100 500,90 L500,40 L40,40 Z"/>
  </g>
  <g fill="rgba(220, 180, 140, 0.6)" stroke="var(--text)" stroke-width="0.8">
    <path d="M40,80 Q70,60 100,80 Q130,100 160,80 Q190,60 220,80 Q250,100 280,80 Q310,60 340,80 Q370,100 400,80 Q430,60 460,80 Q490,100 500,90 L500,140 L40,140 Z"/>
  </g>
...
*Zdroj: BIO přednášky 2025/26, BIO 5 — Rozpoznávání podle otisků prstů (Drahanský). Externí reference: Maltoni, D., Maio, D., Jain, A. K., Prabhakar, S.: *Handbook of Fingerprint Recognition* (2nd ed., Springer 2009) — kanonická reference; Galton, F.: *Finger Prints* (1892); NIST: *NFIQ 2.0 Fingerprint Image Quality* — [github.com/usnistgov/NFIQ2](https://github.com/usnistgov/NFIQ2); ANSI/NIST-ITL 1-2011 *Data Format for Fingerprint Information Transfer*.*
