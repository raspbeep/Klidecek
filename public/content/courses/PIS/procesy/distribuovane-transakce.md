...
2. Každý účastník provede svou část až po `commit()` (zapíše do žurnálu stav `READY` — trvanlivě), ale ještě **necommituje**.
...
<svg viewBox="0 0 540 280" xmlns="http://www.w3.org/2000/svg" style="max-width: 580px;">
  ...
  <text x="90"  y="40" text-anchor="middle" font-family="ui-sans-serif" font-size="12" font-weight="bold">Účastník 1</text>
  <text x="270" y="40" text-anchor="middle" font-family="ui-sans-serif" font-size="12" font-weight="bold">Koordinátor</text>
  <text x="450" y="40" text-anchor="middle" font-family="ui-sans-serif" font-size="12" font-weight="bold">Účastník 2</text>
  ...
  <text x="180" y="85" text-anchor="middle" font-family="ui-monospace" font-size="10">PREPARE</text>
  <line x1="275" y1="90"  x2="445" y2="90"  stroke="var(--ink)" marker-end="url(#arrD)"/>
  <text x="360" y="85" text-anchor="middle" font-family="ui-monospace" font-size="10">PREPARE</text>
  ...
  <text x="180" y="192" text-anchor="middle" font-family="ui-monospace" font-size="10">ACK</text>
  <line x1="445" y1="197" x2="275" y2="197" stroke="var(--ink)" marker-end="url(#arrD)"/>
  <text x="360" y="192" text-anchor="middle" font-family="ui-monospace" font-size="10">ACK</text>
...
<svg viewBox="0 0 540 220" xmlns="http://www.w3.org/2000/svg" style="max-width: 580px;">
  ...
  <text x="70"  y="55" text-anchor="middle" font-family="ui-sans-serif" font-size="13" font-weight="bold">T₁</text>
  <text x="70"  y="70" text-anchor="middle" font-family="ui-sans-serif" font-size="10">commit</text>
  <rect x="140" y="35" width="80" height="40" rx="6" fill="#bbf7d0" stroke="#16a34a"/>
  <text x="180" y="55" text-anchor="middle" font-family="ui-sans-serif" font-size="13" font-weight="bold">T₂</text>
  <text x="180" y="70" text-anchor="middle" font-family="ui-sans-serif" font-size="10">commit</text>
  <rect x="250" y="35" width="80" height="40" rx="6" fill="#bbf7d0" stroke="#16a34a"/>
  <text x="290" y="55" text-anchor="middle" font-family="ui-sans-serif" font-size="13" font-weight="bold">T₃</text>
  <text x="290" y="70" text-anchor="middle" font-family="ui-sans-serif" font-size="10">commit</text>
  ...
  <text x="70"  y="155" text-anchor="middle" font-family="ui-sans-serif" font-size="13" font-weight="bold">T₁</text>
  <rect x="140" y="130" width="80" height="40" rx="6" fill="#bbf7d0" stroke="#16a34a"/>
  <text x="180" y="155" text-anchor="middle" font-family="ui-sans-serif" font-size="13" font-weight="bold">T₂</text>
  <rect x="250" y="130" width="80" height="40" rx="6" fill="#fecaca" stroke="#b91c1c"/>
  <text x="290" y="155" text-anchor="middle" font-family="ui-sans-serif" font-size="13" font-weight="bold">T₃ ✗</text>
  ...
  <text x="180" y="204" text-anchor="middle" font-family="ui-sans-serif" font-size="12" font-weight="bold">C₂</text>
  <rect x="30"  y="185" width="80" height="30" rx="6" fill="#fef3c7" stroke="#ca8a04" stroke-dasharray="4,2"/>
  <text x="70"  y="204" text-anchor="middle" font-family="ui-sans-serif" font-size="12" font-weight="bold">C₁</text>
  ...
  <rect x="390" y="35" width="135" height="180" rx="8" fill="var(--surface)" stroke="var(--muted)"/>
  <text x="457" y="55" text-anchor="middle" font-family="ui-sans-serif" font-size="11" font-weight="bold">Typy orchestrace</text>
  <text x="400" y="75" font-family="ui-sans-serif" font-size="10" font-weight="bold">Choreografie</text>
  <text x="400" y="88" font-family="ui-sans-serif" font-size="9">služby naslouchají</text>
  <text x="400" y="100" font-family="ui-sans-serif" font-size="9">událostem, žádný</text>
  <text x="400" y="112" font-family="ui-sans-serif" font-size="9">centrální koordinátor</text>
  <text x="400" y="140" font-family="ui-sans-serif" font-size="10" font-weight="bold">Orchestrátor</text>
  <text x="400" y="155" font-family="ui-sans-serif" font-size="9">centrální koordinátor</text>
  <text x="400" y="167" font-family="ui-sans-serif" font-size="9">vydává příkazy</text>
  <text x="400" y="179" font-family="ui-sans-serif" font-size="9">a sleduje výsledky</text>
</svg>
:::
