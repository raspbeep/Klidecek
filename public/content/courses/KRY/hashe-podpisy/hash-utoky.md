...
1. **Cylinder reduction** — najdi *pár* zpráv s úzce omezenou rozdílovou strukturou ve stavu.
...
**Combiner $H_1(M) \| H_2(M)$** (kombinace dvou hashovacích funkcí) nepřináší $2n$-bit kolizní bezpečnost. Joux útok dává *jen* $n + n^{1/2}$ bit bezpečnost. Proto se kombinéry hashe v praxi *nepoužívají*.
